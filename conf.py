...
# -*- coding: utf-8 -*-
#
# 系統安裝記錄 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'sphinx.tex', '系統安裝記錄 Documentation',
   '陳國華', 'manual'),
]
...
man_pages = [
    ('index', 'sphinx', '系統安裝記錄 Documentation',
     ['陳國華'], 1)
]
...
texinfo_documents = [
  ('index', 'sphinx', '系統安裝記錄 Documentation',
   '陳國華', 'sphinx', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_author = '陳國華'
epub_publisher = '陳國華'
epub_copyright = '2014, 陳國華'

# The basename for the epub file. It defaults to the project name.
#epub_basename = '系統安裝記錄'
